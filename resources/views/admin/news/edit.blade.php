        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form  class="form-horizontal" action="{{url('admin/news/update',$news->id)}}" method="post" enctype="multipart/form-data">
                                <div class="content">
                                    <legend>{{ $title }}</legend>
                                    {{ csrf_field() }}
                                   <!--  <fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input value="{{$news->title}}" class="form-control" id="title" type="text" name="title"  style="width:40%;"/>
                                            </div>
                                        </div>
                                    </fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="category_id">
                                                    ...
                                                    <option value="{{$v->category_id}}" @if($v->category_id == $news->category_id) selected="selected" @endif >{{$v->category_name}}</option>
                                                    @endforeach
                                                </select>
                            ...
                            <!--         <fieldset>
                                   ...
                                   <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <script name='content' id="editor" type="text/plain" style="width:110%;height:500px;">{!! html_entity_decode($news->content) !!}</script>
                                                <script type="text/javascript">
                                                var ue = UE.getEditor('editor');
                                                </script>
                                            </div>
